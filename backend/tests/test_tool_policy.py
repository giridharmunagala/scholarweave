...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("research.workspace.list", None, True, False),
        ("research.workspace.index", "status", True, False),
        ("research.workspace.index", "refresh", False, True),
        ("research.workspace.organize", "delete_file", False, True),
        ("research.workspace.organize", "move_file", False, True),
        ("research.workspace.organize", "set_tags", False, True),
        ("research.library.organize", "list", True, False),
        ("research.library.organize", "move_paper", False, True),
        ("work.plan.create", None, False, True),
        ("work.plan.update", None, False, True),
        ("work.plan.read", None, True, False),
